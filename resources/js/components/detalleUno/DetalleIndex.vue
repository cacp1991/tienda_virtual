<template>
	<div class="card m-5 ">
		<div class="card-header bg-warning text-white">Detalle del articulo</div>
		<div class="card-body ">
            ...
            <div><input type="number" v-model="product.stock" /></div>
			<hr />
		...
		methods: {
            ...
            añadirProducto() {
				...
				this.products.map(productoslistados => {
					this.stock += productoslistados.stock * productoslistados.price
				})
